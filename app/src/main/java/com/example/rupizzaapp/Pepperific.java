...
/**
 * Set-up for the Pepperific Specialty Pizza.
 * @author Haejin Song, Deshna Doshi
 */
public class Pepperific extends Pizza {

    /**
     * Constructor to create a Pepperific Pizza.
     ...
     */
    public Pepperific(Size size, Sauce sauce, boolean extraSauce, boolean extraCheese) {
    ...
    public String toString(){
        return "[Pepperific] GreenPepper, Pepperoni, Sausage, Mushroom, " + size.toString().toLowerCase() + ", " + sauce.toString().toLowerCase()
