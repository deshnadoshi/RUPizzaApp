...
/**
 * Set-up for the Tropizest Specialty Pizza.
 * @author Haejin Song, Deshna Doshi
 */
public class Tropizest extends Pizza {

    /**
     * Constructor to create a Tropizest Pizza.
     ...
     */
    public Tropizest(Size size, Sauce sauce, boolean extraSauce, boolean extraCheese) {
    ...
    public String toString(){
        return "[Tropizest] Pineapple, BlackOlives, Ham, Pepperoni, " + size.toString().toLowerCase() + ", " + sauce.toString().toLowerCase()
