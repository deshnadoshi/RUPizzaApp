...
/**
 * Set-up for the Hawaiian Specialty Pizza.
 * @author Haejin Song, Deshna Doshi
 */
public class Hawaiian extends Pizza {

    /**
     * Constructor to create a Hawaiin Pizza.
     ...
     */
    public Hawaiian(Size size, Sauce sauce, boolean extraSauce, boolean extraCheese) {
    ...
    public double price() {
        ...
        return Double.parseDouble(String.format("%.2f", 12.99 + size.getCode() + add));
    }
    ...
    public String toString(){
        return "[Hawaiian] Pineapple, BlackOlives, Ham, Pepperoni, " + size.toString().toLowerCase() + ", " + sauce.toString().toLowerCase()
