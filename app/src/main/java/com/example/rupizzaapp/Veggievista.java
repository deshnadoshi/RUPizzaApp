...
/**
 * Set-up for the Veggievista Specialty Pizza.
 * @author Haejin Song, Deshna Doshi
 */
public class Veggievista extends Pizza {

    /**
     * Constructor to create a Veggievista Pizza.
     ...
     */
    public Veggievista(Size size, Sauce sauce, boolean extraSauce, boolean extraCheese) {
    ...
    public double price() {
        ...
        return Double.parseDouble(String.format("%.2f", 13.99 + size.getCode() + add));
    }
    ...
    public String toString(){
        return "[Veggievista] GreenPepper, Onion, BlackOlives, Mushroom, " + size.toString().toLowerCase() + ", " + sauce.toString().toLowerCase()
